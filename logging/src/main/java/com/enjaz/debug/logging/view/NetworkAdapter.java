...
public class NetworkAdapter extends RecyclerView.Adapter<NetworkAdapter.ViewHolder> {
    ...
    public NetworkAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.network_details, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final NetworkAdapter.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.errorid.setText("error  "+networkCallInformationForDB.getFailureId());
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        TextView requestParameter, causeOfError, requestUrl, date ,errorid;
        FoldingCell fc;
        ViewHolder(@NonNull View itemView) {
            ...
            errorid=itemView.findViewById(R.id.errorid);
            fc = itemView.findViewById(R.id.folding_cell1);
